...
<html lang="zh-cn">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-12">
        <div class="col-sm-9 text-center" id="div-table">
          <div id="div-thead"><!--  class="thead-fixed" -->
            <table class="table table-hover table-bordered" >
              <thead id="thead"><tr><th colspan=2>序号</th><th colspan=7>姓名</th><th colspan=2>性别</th><th colspan=2>年龄</th><th colspan=4>电话</th></tr></thead>
        ...
        <div class="col-sm-3 control-container">
          ...
          <div class="col-sm-12" id="div-select">
            ...
            <div class="col-sm-12">
              <div class="col-sm-12" id="div-halfDay">
        ...
        <div class="col-sm-12" id="div-display-count">
          <div class="col-sm-12">
          ...
          <div class="col-sm-12">
            <div class="col-sm-12" id="div-count">
              <!-- <h1 class="text-center"><strong>剩余人数</strong></h1> -->
              <!-- <div class="col-sm-12">
                <h1 class="text-center"><strong>上午剩&nbsp;</strong><strong id="morningCount">0</strong><strong>&nbsp;人</strong></h1>
              </div> -->
              <!-- <div class="col-sm-12">
                <h1 class="text-center"><strong>下午剩&nbsp;</strong><strong id="afternoonCount">0</strong><strong>&nbsp;人</strong></h1>
              </div> -->
            </div>  
           </div>
        </div>
    ...
    $(document).ready(function() {
      ...
      function setCurrentId(id){
        // console.info("--setCurrentId--");
        if(isAfternoon == 0){
          // console.info("--morningCurrentId--");
          morningCurrentId = id;
        }else{
          // console.info("--afternoonCurrentId--");
      ...
      function position(){
        // table font-size
        $("table").css("font-size", $(window).width()*0.027);
        $("h1").css("font-size", $(window).width()*0.02);
        $("h2").css("font-size", $(window).width()*0.018);
        $("button").css("font-size", $(window).width()*0.015);
      ...
      function selectHalfDay(){
        $("#halfDay button").click(function(){
          ...
          // set current id
          // console.info("---selectHalfDay---");
          // console.info("getCurrentId():"+getCurrentId());
          // console.info("getTrs().length:"+getTrs().length);
          // if(getCurrentId() == -1 && getTrs().length > 0){
          //   setCurrentId(getTrs().first().attr("name"));
          //   console.info("getCurrentId():"+getCurrentId());
          // }
      ...
      function showTable(){
        ...
        for(var i = 0;i<data.length; i++){
          ...
          $("<tr name='"+data[i].id+"'><td colspan=2>"+number+"</td><td colspan=7><img width='100%' src='data:"+data[i].name+"' ></td><td colspan=2>"+gender+"</td><td colspan=2>"+data[i].age+"</td><td colspan=4>"+phone+"</td></tr>").appendTo(tbody);
        }
      }
      showTable();
